...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Saga Tejaswi Lakshmi Priya Durga — Data & BI Analyst" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Saga Tejaswi Lakshmi Priya Durga" },
      {
        property: "og:title",
        content: "Saga Tejaswi Lakshmi Priya Durga — Data & BI Analyst",
      },
      {
